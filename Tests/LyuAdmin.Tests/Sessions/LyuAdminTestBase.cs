...
namespace LyuAdmin.Tests.Sessions
{
    public abstract class LyuAdminTestBase : AbpIntegratedTestBase
    {
        protected LyuAdminTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<LyuAdminApplicationModule>();
            modules.Add<LyuAdminDataModule>();
        }

        public void UsingDbContext(Action<LyuAdminDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<LyuAdminDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<LyuAdminDbContext, T> func)
        {
            T result;
